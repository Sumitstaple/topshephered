...
//pets api
Route::get('/pets/all', [App\Http\Controllers\PetsController::class, 'getallpet']);
Route::get('/pets/getPreallpets/{limit}', [App\Http\Controllers\PetsController::class, 'getPreallpets']);
Route::get('/pets/all/{limit}', [App\Http\Controllers\PetsController::class, 'index']);
